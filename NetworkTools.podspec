...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is NetworkTools
                   DESC

  s.homepage     = "https://gitlab.com/bluajack-BasicComponents/NetworkTools"
  ...
  s.source       = { :git => "https://gitlab.com/bluajack-BasicComponents/NetworkTools.git", :tag => s.version.to_s }
  ...
  s.source_files  = "NetworkTools/NetworkTools/**/*.{h,m,swift}"
